...
@Component({
  selector: 'app-emailbroadcast',
  templateUrl: './emailbroadcast.page.html',
  styleUrls: ['./emailbroadcast.page.scss'],
})
export class EmailbroadcastPage implements OnInit {
  ...
  openFilterModal()
  {
    this.navCtrl.navigateForward(['../filteremail']);
  }
  checkMaster() {
    this.selectedArray=[];
    setTimeout(()=>{
