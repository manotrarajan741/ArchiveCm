...
@Component({
  selector: 'app-filteremail',
  templateUrl: './filteremail.page.html',
  styleUrls: ['./filteremail.page.scss'],
})
export class FilteremailPage implements OnInit {
  resultData:any;
  citylist:any;
  grouplist:any;
  cityadd:any;
  ...
  ngOnInit() {
    ...
    if(this.groupadd == '' || this.groupadd == undefined){
     ...
     this.navCtrl.navigateForward(['/filterpageemail',{ "cityadd": this.cityadd ,"groupadd" : this.groupadd}]);
